...
const Navbar = ({ sectionsRef }) => {
    ...
    const navItems = ["Home", "About", "Skills", "Projects", "Experience", "Contact"]; // Add Experience
                        ...
                        <nav className="flex flex-col items-start space-y-6 text-white">
                            {navItems.map((item, index) => (
                                <motion.button
                                    ...
                                    whileHover={{
                                        scale: 1.1,
                                        textShadow: "0px 0px 8px rgba(20, 184, 166, 0.8)", // Teal glow
                                    }}
